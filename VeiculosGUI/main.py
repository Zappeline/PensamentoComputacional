...
# Classe principal
class SistemaVeiculos_Proprietario:
    ...
    def configurar_tela_cadastro_proprietario(self):
        # Título
        titulo = tk.Label(self.tela_cadastroproprietario, text="CADASTRO DE PROPRIETARIOS", font=("Arial", 16, "bold"))
        titulo.pack(pady=20)
        ...
        tk.Label(form_frame, text="Veiculo:").grid(row=1, column=0, sticky="e", pady=5)
        self.veiculo_entry = tk.Entry(form_frame, width=20)
        self.veiculo_entry.grid(row=1, column=1, sticky="w", pady=5)
...
if __name__ == "__main__":
    root = tk.Tk()
    app = SistemaVeiculos_Proprietario(root)
    root.mainloop()